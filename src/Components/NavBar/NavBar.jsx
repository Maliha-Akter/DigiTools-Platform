...
const NavBar = ({ cartArray, setCartArray }) => {
    return (
        <div className='container mx-auto px-15 sticky top-0 z-50'>
            <div className="navbar bg-base-100 shadow-sm">
                ...
                <div className="navbar-end space-x-6 flex items-center">
                    <div className="indicator">
                        ...
                        <span className="badge badge-sm indicator-item font-bold text-sm">{
                        cartArray.length ===0? 
                        "":
                        cartArray.length
                        }</span>
                    </div>
                    <h1 className='text-[#101727] font-semibold hidden md:block'>Login</h1>
